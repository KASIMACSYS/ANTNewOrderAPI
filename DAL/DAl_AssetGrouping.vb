...
Public Class DAl_AssetGrouping

    Dim dt As DataTable
    Dim BaseConn As New SQLConn()

    Public Sub Get_Structure(ByRef Obj As csAssetGrouping, ByVal _StrDBPath As String, ByVal _StrDBPwd As String, ByRef ErrNo As Integer, ByRef ErrStr As String)
        ErrNo = 0
        ErrStr = ""
        Try
            BaseConn.Open(_StrDBPath, _StrDBPwd)
            BaseConn.cmd = New SqlClient.SqlCommand("[AssetGroupingUpdated]", BaseConn.cnn)
            ...
            BaseConn.cmd.Parameters.AddWithValue("@AssetID", Obj.str_ProductID)
        ...
        End Try
    End Sub
    Public Sub Get_Structure1(ByRef Obj As csAssetGrouping, ByVal _StrDBPath As String, ByVal _StrDBPwd As String, ByRef _ErrNo As Integer, ByRef _ErrStr As String)
        _ErrNo = 0
        _ErrStr = ""
        Try
            BaseConn.Open(_StrDBPath, _StrDBPwd)
            BaseConn.cmd = New SqlClient.SqlCommand("[GetAssetGrouping]", BaseConn.cnn)
            BaseConn.cmd.CommandType = CommandType.StoredProcedure
            BaseConn.cmd.Parameters.AddWithValue("@CID", Obj.str_SiteID)
            BaseConn.cmd.Parameters.AddWithValue("@BusinessPeriodID", Obj.int_BusinessPerionID)
            BaseConn.cmd.Parameters.AddWithValue("@AssetID", Obj.str_ProductID)
    ...
    '    Try
    '        BaseConn.Open(_StrDBPath, _StrDBPwd)
    '        BaseConn.cmd = New SqlClient.SqlCommand("[sp_GetStockForProductGrouping]", BaseConn.cnn)
    '        BaseConn.cmd.CommandType = CommandType.StoredProcedure
